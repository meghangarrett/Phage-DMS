---
title: "Analysis of 257D selection with gp41/V3 Phage-DMS libraries"
...
ggsave(file = "results/mAb_analysis/gp41V3_257D/x257D_correlation_rep1.jpg", x257D_correlation)

beads_correlation <- ggplot(analysis_rep1_no_outlier, aes(x=beads_1, y=beads_2)) + geom_point()
ggsave(file = "results/mAb_analysis/gp41V3_257D/beads_correlation_rep1.jpg", beads_correlation)


```

```{r}
x2019_02_04_correlation_plots <- grid.arrange(arrangeGrob(x257D_correlation, beads_correlation, ncol=2, top="2019.02.04 correlation plots"))


ggsave(file="results/mAb_analysis/gp41V3_257D/2019_02_04_correlation_plots.jpg", x2019_02_04_correlation_plots)
```
...
ggsave(file = "results/mAb_analysis/gp41V3_257D/x257D_correlation_rep1_fig.jpg", x257D_correlation)
```
...
**BG505 gp41**
```{r}
fold_enrichment_257D_BG505_gp41 <- analysis_rep1 %>% filter(Protein == 'gp41' & Virus == 'BG505' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BG505 gp41 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_BG505_gp41_rep1.jpg", fold_enrichment_257D_BG505_gp41, width=8)
```

**BF520 gp41**
```{r}
fold_enrichment_257D_BF520_gp41 <- analysis_rep1 %>% filter(Protein == 'gp41' & Virus == 'BF520' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BF520 gp41 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_BF520_gp41_rep1.jpg", fold_enrichment_257D_BF520_gp41, width=8)
```

**ZA1197 gp41**
```{r}
fold_enrichment_257D_ZA1197_gp41 <- analysis_rep1 %>% filter(Protein == 'gp41' & Virus == 'ZA1197' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "ZA1197 gp41 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_ZA1197_gp41_rep1.jpg", fold_enrichment_257D_ZA1197_gp41, width=8)
```

**BG505 V3**
```{r}
fold_enrichment_257D_BG505_V3 <- analysis_rep1 %>% filter(Protein == 'V3' & Virus == 'BG505' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BG505 V3 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_BG505_V3_rep1.jpg", fold_enrichment_257D_BG505_V3, width=8)
```

**BF520 V3**
```{r}
fold_enrichment_257D_BF520_V3 <- analysis_rep1 %>% filter(Protein == 'V3' & Virus == 'BF520' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BF520 V3 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_BF520_V3_rep1.jpg", fold_enrichment_257D_BF520_V3, width=8)
```

**ZA1197 V3**
```{r}
fold_enrichment_257D_ZA1197_V3 <- analysis_rep1 %>% filter(Protein == 'V3' & Virus == 'ZA1197' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "ZA1197 V3 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_ZA1197_V3_rep1.jpg", fold_enrichment_257D_ZA1197_V3, width=8)
```
...
***BG505_V3***
```{r}
letter_plot_257D_BG505_V3 <- analysis_rep1 %>% filter(Virus == 'BG505' & Protein == 'V3') %>%
  ggplot() + geom_text(aes(x = Loc, y = scaled_diff_select_257D, label = AA)) +coord_fixed(ratio=0.5) +theme_classic(base_size = 14) +labs(x="BG505 V3 amino acid position", y="scaled differential selection") 
ggsave(file="results/mAb_analysis/gp41V3_257D/letter_plot_257D_BG505_V3_rep1.jpg", letter_plot_257D_BG505_V3, width=10)
```


***BF520_V3***
```{r}
letter_plot_257D_BF520_V3 <- analysis_rep1 %>% filter(Virus == 'BF520' & Protein == 'V3') %>%
  ggplot() + geom_text(aes(x = Loc, y = scaled_diff_select_257D, label = AA)) +coord_fixed(ratio=2) +theme_classic(base_size = 14) +labs(x="BF520 V3 amino acid position", y="scaled differential selection") 
ggsave(file="results/mAb_analysis/gp41V3_257D/letter_plot_257D_BF520_V3_rep1.jpg", letter_plot_257D_BF520_V3, width=10)
```


***ZA1197_V3***
```{r}
letter_plot_257D_ZA1197_V3 <- analysis_rep1 %>% filter(Virus == 'ZA1197' & Protein == 'V3') %>%
  ggplot() + geom_text(aes(x = Loc, y = scaled_diff_select_257D, label = AA)) +coord_fixed(ratio=1) +theme_classic(base_size = 14) +labs(x="ZA1197 V3 amino acid position", y="scaled differential selection") 
ggsave(file="results/mAb_analysis/gp41V3_257D/letter_plot_257D_ZA1197_V3_rep1.jpg", letter_plot_257D_ZA1197_V3, width=10)
```
...
```{r}
analysis_rep2_no_outlier <- analysis_rep2 %>% select(x257D_1, x257D_2, beads_1, beads_2, input_1, input_2) %>%  filter_all(all_vars(.< 5500))
...
ggsave(file = "results/mAb_analysis/gp41V3_257D/x257D_correlation_rep2.jpg", x257D_correlation)

beads_correlation <- ggplot(analysis_rep2_no_outlier, aes(x=beads_1, y=beads_2)) + geom_point()
ggsave(file = "results/mAb_analysis/gp41V3_257D/beads_correlation_rep2.jpg", beads_correlation)

input_correlation <- ggplot(analysis_rep2_no_outlier, aes(x=input_1, y=input_2)) + geom_point()
ggsave(file = "results/mAb_analysis/gp41V3_257D/input_correlation_rep2.jpg", input_correlation)


```

```{r}
x2019_02_04_Lib1_correlation_plots <- grid.arrange(arrangeGrob(x257D_correlation, beads_correlation, input_correlation, ncol=2, top="2019.02.04 Lib1 correlation plots"))


ggsave(file="results/mAb_analysis/gp41V3_257D/2019_02_04_Lib1_correlation_plots.jpg", x2019_02_04_Lib1_correlation_plots)
```
...
ggsave(file = "results/mAb_analysis/gp41V3_257D/x257D_correlation_rep2_fig.jpg", x257D_correlation)
```
...
**BG505 gp41**
```{r}
fold_enrichment_257D_BG505_gp41 <- analysis_rep2 %>% filter(Protein == 'gp41' & Virus == 'BG505' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BG505 gp41 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_BG505_gp41_rep2.jpg", fold_enrichment_257D_BG505_gp41, width=8)
```

**BF520 gp41**
```{r}
fold_enrichment_257D_BF520_gp41 <- analysis_rep2 %>% filter(Protein == 'gp41' & Virus == 'BF520' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BF520 gp41 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_BF520_gp41_rep2.jpg", fold_enrichment_257D_BF520_gp41, width=8)
```

**ZA1197 gp41**
```{r}
fold_enrichment_257D_ZA1197_gp41 <- analysis_rep2 %>% filter(Protein == 'gp41' & Virus == 'ZA1197' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "ZA1197 gp41 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_ZA1197_gp41_rep2.jpg", fold_enrichment_257D_ZA1197_gp41, width=8)
```

**BG505 V3**
```{r}
fold_enrichment_257D_BG505_V3 <- analysis_rep2 %>% filter(Protein == 'V3' & Virus == 'BG505' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BG505 V3 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_BG505_V3_rep2.jpg", fold_enrichment_257D_BG505_V3, width=8)
```

**BF520 V3**
```{r}
fold_enrichment_257D_BF520_V3 <- analysis_rep2 %>% filter(Protein == 'V3' & Virus == 'BF520' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BF520 V3 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_BF520_V3_rep2.jpg", fold_enrichment_257D_BF520_V3, width=8)
```

**ZA1197 V3**
```{r}
fold_enrichment_257D_ZA1197_V3 <- analysis_rep2 %>% filter(Protein == 'V3' & Virus == 'ZA1197' & type == 'WT') %>% ggline( x='Loc', y = 'fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "ZA1197 V3 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/fold_enrichment_257D_ZA1197_V3_rep2.jpg", fold_enrichment_257D_ZA1197_V3, width=8)
```
...
***BG505_V3***
```{r}
letter_plot_257D_BG505_V3 <- analysis_rep2 %>% filter(Virus == 'BG505' & Protein == 'V3') %>%
  ggplot() + geom_text(aes(x = Loc, y = scaled_diff_select_257D, label = AA)) +coord_fixed(ratio=1) +theme_classic(base_size = 14) +labs(x="BG505 V3 amino acid position", y="scaled differential selection") 
ggsave(file="results/mAb_analysis/gp41V3_257D/letter_plot_257D_BG505_V3_rep2.jpg", letter_plot_257D_BG505_V3, width=10)
```


***BF520_V3***
```{r}
letter_plot_257D_BF520_V3 <- analysis_rep2 %>% filter(Virus == 'BF520' & Protein == 'V3') %>%
  ggplot() + geom_text(aes(x = Loc, y = scaled_diff_select_257D, label = AA)) +coord_fixed(ratio=2) +theme_classic(base_size = 14) +labs(x="BF520 V3 amino acid position", y="scaled differential selection") 
ggsave(file="results/mAb_analysis/gp41V3_257D/letter_plot_257D_BF520_V3_rep2.jpg", letter_plot_257D_BF520_V3, width=10)
```

***ZA1197_V3***

```{r}
letter_plot_257D_ZA1197_V3 <- analysis_rep2 %>% filter(Virus == 'ZA1197' & Protein == 'V3') %>%
  ggplot() + geom_text(aes(x = Loc, y = scaled_diff_select_257D, label = AA)) +coord_fixed(ratio=1) +theme_classic(base_size = 14) +labs(x="ZA1197 V3 amino acid position", y="scaled differential selection") 
ggsave(file="results/mAb_analysis/gp41V3_257D/letter_plot_257D_ZA1197_V3_rep2.jpg", letter_plot_257D_ZA1197_V3, width=10)
```
...
```{r}
avg_analysis <- analysis_rep1 %>% select(id, Virus, Protein, Loc, AA, type, HXB2_Loc, Correct_Loc, rep1_sum_257D=sum_257D, rep1_fold_enrich_257D=fold_enrich_257D, rep1_scaled_diff_select_257D=scaled_diff_select_257D)
```

```{r}
rep2 <- analysis_rep2 %>% select(id, Virus, Protein, Loc, AA, type, HXB2_Loc, Correct_Loc, rep2_sum_257D=sum_257D, rep2_fold_enrich_257D=fold_enrich_257D, rep2_scaled_diff_select_257D=scaled_diff_select_257D) 
...
ggsave(file = "results/mAb_analysis/gp41V3_257D/x257D_correlation_biological_duplicates.jpg", x257D_correlation)
```
...
ggsave(file = "results/mAb_analysis/gp41V3_257D/x257D_correlation_biological_duplicates_nooutlier.jpg", x257D_correlation)
```
...
```{r}
library(ggpubr)
fold_enrichment_257D_BG505_gp41 <- avg_analysis %>% filter(Protein == 'gp41' & Virus == 'BG505' & type == 'WT') %>% ggline( x='Loc', y = 'avg_fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BG505 gp41 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/avg_fold_enrich_257D_BG505_gp41_rep2.jpg", fold_enrichment_257D_BG505_gp41, width=8)
```

**BF520 gp41**
```{r}
fold_enrichment_257D_BF520_gp41 <- avg_analysis %>% filter(Protein == 'gp41' & Virus == 'BF520' & type == 'WT') %>% ggline( x='Loc', y = 'avg_fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BF520 gp41 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/avg_fold_enrich_257D_BF520_gp41_rep2.jpg", fold_enrichment_257D_BF520_gp41, width=8)
```

**ZA1197 gp41**
```{r}
fold_enrichment_257D_ZA1197_gp41 <- avg_analysis %>% filter(Protein == 'gp41' & Virus == 'ZA1197' & type == 'WT') %>% ggline( x='Loc', y = 'avg_fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "ZA1197 gp41 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/avg_fold_enrich_257D_ZA1197_gp41_rep2.jpg", fold_enrichment_257D_ZA1197_gp41, width=8)
```
**Combined V3**
```{r}
fold_enrichment_257D_V3 <- avg_analysis %>% filter(Protein == 'V3' & type == 'WT') %>% ggline( x='HXB2_Loc', y = 'avg_fold_enrich_257D', group = 'Virus', color = 'Virus', palette = 'Dark2', add = NULL, conf.int = FALSE, cor.coef = FALSE, xlab = "HXB2 Env amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 22) + scale_x_discrete( breaks = c(290, 300, 310, 320))

fold_enrichment_257D_V3 <- ggpar(fold_enrichment_257D_V3, ylim = c(-1, 20), legend=c(.9,.8))

ggsave(file="results/mAb_analysis/gp41V3_257D/avg_fold_enrichment_257D_V3.jpg", fold_enrichment_257D_V3, width=10)
```

**BG505 V3**
```{r}
fold_enrichment_257D_BG505_V3 <- avg_analysis %>% filter(Protein == 'V3' & Virus == 'BG505' & type == 'WT') %>% ggline( x='Loc', y = 'avg_fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BG505 V3 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/avg_fold_enrich_257D_BG505_V3_rep2.jpg", fold_enrichment_257D_BG505_V3, width=8)
```

**BF520 V3**
```{r}
fold_enrichment_257D_BF520_V3 <- avg_analysis %>% filter(Protein == 'V3' & Virus == 'BF520' & type == 'WT') %>% ggline( x='Loc', y = 'avg_fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "BF520 V3 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/avg_fold_enrich_257D_BF520_V3_rep2.jpg", fold_enrichment_257D_BF520_V3, width=8)
```

**ZA1197 V3**
```{r}
fold_enrichment_257D_ZA1197_V3 <- avg_analysis %>% filter(Protein == 'V3' & Virus == 'ZA1197' & type == 'WT') %>% ggline( x='Loc', y = 'avg_fold_enrich_257D',
                   add = NULL, conf.int = FALSE,
                   cor.coef = FALSE,
                   xlab = "ZA1197 V3 amino acid position", ylab = "fold enrichment") +theme_classic(base_size = 14) 
ggsave(file="results/mAb_analysis/gp41V3_257D/avg_fold_enrich_257D_ZA1197_V3_rep2.jpg", fold_enrichment_257D_ZA1197_V3, width=8)
```
...
***BG505_V3***
```{r}
letter_plot_257D_BG505_V3 <- avg_analysis %>% filter(Virus == 'BG505' & Protein == 'V3') %>%
  ggplot() + geom_text(aes(x = Loc, y = avg_scaled_diffselect_257D, label = AA)) +coord_fixed(ratio=0.3) +theme_classic(base_size = 14) +labs(x="BG505 V3 amino acid position", y="scaled differential selection") 
ggsave(file="results/mAb_analysis/gp41V3_257D/letter_plot_257D_BG505_V3_avg.jpg", letter_plot_257D_BG505_V3, width=10)
```


***BF520_V3***
```{r}
letter_plot_257D_BF520_V3 <- avg_analysis %>% filter(Virus == 'BF520' & Protein == 'V3') %>%
  ggplot() + geom_text(aes(x = Loc, y = avg_scaled_diffselect_257D, label = AA)) +coord_fixed(ratio=2) +theme_classic(base_size = 14) +labs(x="BF520 V3 amino acid position", y="scaled differential selection") 
ggsave(file="results/mAb_analysis/gp41V3_257D/letter_plot_257D_BF520_V3_avg.jpg", letter_plot_257D_BF520_V3, width=10)
```

***ZA1197_V3***

```{r}
letter_plot_257D_ZA1197_V3 <- avg_analysis %>% filter(Virus == 'ZA1197' & Protein == 'V3') %>%
  ggplot() + geom_text(aes(x = Loc, y = avg_scaled_diffselect_257D, label = AA)) +coord_fixed(ratio=0.2) +theme_classic(base_size = 14) +labs(x="ZA1197 V3 amino acid position", y="scaled differential selection") 
ggsave(file="results/mAb_analysis/gp41V3_257D/letter_plot_257D_ZA1197_V3_avg.jpg", letter_plot_257D_ZA1197_V3, width=10)
```
...
```{r}
write.csv(BG505_V3_matrix, file="results/mAb_analysis/gp41V3_257D/BG505_V3_257D_matrix.csv")
```
